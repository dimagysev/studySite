...
//         $( '#nav > ul, #nav .menu > ul' ).hide();
    ...
    function classic_dropdown() {
        var show_dropdown = function()
        {
            ...
            let containerWidth = $('#header').width();
            let marginRight = $('.classic ul#nav > li').css('margin-right');
            let submenuWidth = $('.classic #nav ul.sub-menu').width();
            let offsetMenuRight = $(this).position().left + submenuWidth;
            let leftPos = -18;
        ...
        $('#nav li ul.sub-menu li, #nav li ul.children li').hover(
            function()
            {
               ...
               var containerWidth = $('#header').width();
                var containerOffsetRight = $('#header').offset().left + containerWidth;
               var submenuWidth = $('ul.sub-menu, ul.children', this).parent().width();
                var offsetMenuRight = $(this).offset().left + submenuWidth * 2;
                var leftPos = -10;
