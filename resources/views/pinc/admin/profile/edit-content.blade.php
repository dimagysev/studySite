...
@endif
<form method="post" enctype="multipart/form-data" action="{{ route('admin.profile.update', ['user' => $currentUser->id]) }}">
    @csrf
    @method('put')
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control" value="{{ $currentUser->name }}">
                            </div>

                            <div class="form-group">
                                <label for="login">{{ __('pincrio.login') }}</label>
                                <input type="text" name="login" id="login" class="form-control" value="{{$currentUser->login}}">
                            </div>
