...
@endif
<form method="post" enctype="multipart/form-data" action="{{ route('admin.categories.update', ['alias' => $currentCategory->alias]) }}">
    @csrf
    @method('put')
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="alias" id="alias" value="{{ $currentCategory->alias }}">
                            </div>
